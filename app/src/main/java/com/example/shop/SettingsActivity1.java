...
public class SettingsActivity1 extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo()
    {
        ...
        startActivity(new Intent( SettingsActivity1.this, HomeActivity.class));
        Toast.makeText( SettingsActivity1.this, "Profile Info update successfully.", Toast.LENGTH_SHORT).show();
        finish();
    }
